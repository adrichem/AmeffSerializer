...
#error "Naar file moet tijdens serialisatie, niet deserialisatie"
    [TestClass]
    public class TestV3
    {
        #region privates
        ...
        private MemoryStream Serialize<T> (T Model)
        {
        ...
        private DeserializationResult<T> Deserialize<T>(Stream Stream, XmlReaderSettings Settings, string FileName)
        {
        ...
        public void Model()
        {
            ...
            var Result = Deserialize<ModelType>(Buffer, MyXmlReaderSettings, TempFileName(string.Empty));
        ...
        public void Documentation()
        {
            ...
            MemoryStream Buffer = Serialize(new ModelType
            {
                identifier = "id-1",
                name = new List<LangStringType> { new LangStringType { Value = "empty" } },
        ...
        {            
            ...
            MemoryStream Buffer = Serialize(MyModel);
        ...
        public void RGBColor()
        {
            var ValidationIssues = new List<ValidationEventArgs>();
            var MyXmlReaderSettings = ReaderSettings(ValidationIssues);
            var Buffer = Serialize(new RGBColorType
            {
                r = 255,
                g = 255,
                b = 255,
            ...
            var Result = Deserialize<RGBColorType>(Buffer, MyXmlReaderSettings, TempFileName("1"));
            ...
            Buffer = Serialize(new RGBColorType
            {
                r = 255,
                g = 255,
                b = 255,
            ...
            Result = Deserialize<RGBColorType>(Buffer, MyXmlReaderSettings, TempFileName("2"));
